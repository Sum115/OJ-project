    ...
    return (
        <div className="text-white mx-10 mt-2">
            <div>
                ...
                <input  className="border rounded-md w-full bg-black" type="text" 
                            value={pName}
                ...
                <textarea   className="border w-full rounded-lg bg-black" type="text" rows={10}
                            value={statement}
                ...
                <textarea   className="border w-full rounded-lg bg-black" type="text" rows={7} 
                            value={constraint}
